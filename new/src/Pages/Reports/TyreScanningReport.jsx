...
import { getScanningTyreSubReportguid, getTyreScanningReportList } from "../../core/services/ReportApiServices";
import { useDispatch, useSelector } from "react-redux";
...
import Report2 from "./AddViewReports/Report2";
import { format } from 'date-fns';

const TyreScanningReports = () => {
...
const toggleSortOrder = () => {
  ...
  : [];
  const handleTyreScanningReportList = async () => {
    setIsLoading(true); // Set loader to true before fetching data
    try {
      // const response = await getTyreScanningReportList(selectedCategory,fullname,racerNo);
      const response = await getTyreScanningReportList(fullname);
  ...
  const handleVeiwClick = async (guid) => {
    ...
    try {
      const response = await getScanningTyreSubReportguid(guid);
  ...
  const handleRefresh = () => {
    handleTyreScanningReportList()// Reset the data to initialEventData
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a, b) => a.racerNumber.length - b.racerName.length,
    },
        ...
        <div className="content">
          ...
          <div className="card table-list-card">
            <div className="card-body">
              ...
              <div className="card-body pb-0 m-3">
...
export default TyreScanningReports;
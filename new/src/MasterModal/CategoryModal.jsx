...
import { addNewCategory, editCategory } from "../core/services/MasterApiServices";
...
//   const { userId } = useSelector((state) => state.userauth);
  ...
  const handleFormSubmit = async (formData) => {
    ...
    try {
      const response =
        mode === "edit" ? await editCategory(objCategory) : await addNewCategory(objCategory);
            ...
            <div className="page-wrapper-new p-0">
              <div className="content">
                <div className="modal-header border-0 custom-modal-header">
                  ...
                  <h4>{mode === "edit" ? "Edit Category" : "Add Category"}</h4>
                  </div>
                  <button
                    type="button"
                    className="close"

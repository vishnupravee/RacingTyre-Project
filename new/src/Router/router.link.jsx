...
import RacerMasters from "../Pages/Masters/RacerMasters";
import EventRegistration from "../Pages/Transactions/EventRegistration";
import TyreReports from "../Pages/Reports/TyreReports";
import UserList from "../Pages/UserAdministration/UserList";
import TyreRegistrationList from "../Pages/Transactions/TyreRegistrationList";
import RejectionReports from "../Pages/Reports/RejectionReports";
import TyreScanningReports from "../Pages/Reports/TyreScanningReport";
import SignIn from "../Pages/Login/Signin";
import TyreRegisterReport from "../Pages/Reports/TyreRegisterReport";
import TyreIssueDetail from "../Pages/Reports/TyreIssueDetail";
export const publicRoutes = [
  ...
  {
    id: 122,
    path: routes.racermaster,
    name: "racermaster",
    element: <RacerMasters />,
    route: Route,
  },
  {
    id: 123,
  ...
  {
    id: 124,
    path: routes.tyreregistration,
    name: "tyreregistration",
    element: <TyreRegistrationList />,
    route: Route,
  },
  {
    id: 125,
    path: routes.tyrescanningreports,
    name: "tyrescanningreports",
    element: <TyreScanningReports />,
    route: Route,
  },
  {
    id: 126,
    path: routes.tyrereports,
    name: "tyrereports",
    element: <TyreReports />,
    route: Route,
  },
...
{
    id: 128,
    path: routes.tyreregisterreports,
    name: "tyreregisterreports",
    element: <TyreRegisterReport />,
    route: Route,
  },
{
    id: 129,
    path: routes.tyreissuedetail,
    name: "tyreissuedetail",
    element: <TyreIssueDetail />,
    route: Route,
  },
];
